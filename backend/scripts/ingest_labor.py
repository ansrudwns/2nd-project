...
# Config mapping: folder_name -> index_name (LABOR ONLY)
INDEX_MAP = {
...
# --- Specialized Parsers ---
# Reused same logic as Lease for consisteny
...
def ingest_data(data_dir):
    ...
    logger.info("Starting [LABOR] Data Ingestion...")

    for category, index_name in INDEX_MAP.items():
